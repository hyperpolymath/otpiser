...
// Replace otpiser, Otpiser — See README.adoc for details., just run, Otpiser started successfully. with actuals
= otpiser — Quick Start for Users
:toc:
:toclevels: 2

== What is otpiser?

Otpiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./otpiser-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/otpiser/wiki
